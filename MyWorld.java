...
public class MyWorld extends World {
     ...
     * Postcondition: New MyWorld object created with 600x400 cells and 1x1 pixels,
     * new Elephant object (elephant) created, and createApple() method called.
     */
    ...
    /**
     * Increase score for every apple the elephant eats and
     * increases the level for every 5 apples the elephant eats.
     * Precondition:
     * For increased score: The elephant eats 1 apple.
     * For increased level: Number of apples eaten by the elephant is a factor of 5.
     ...
     * Precondition: Called by MyWorld constructor (requiring MyWorld object to be created).
     * Postcondition: New Apple object created at random place at the top of the screen.
     */
